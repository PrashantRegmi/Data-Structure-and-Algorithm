/* WAP in C to store student rollno,height and weight in a stack in sorted order of rollno.
Also there should be a provision for revising the weight of any student by using pop operation and 
push operation. */
